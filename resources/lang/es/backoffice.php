...
return [
    ...
    'wms_tiled' => 'WMS Tiled',
    'wms_layers' => 'WMS Layers (separate with comma; no spaces; use * for all columns)',
    'wfs_url' => 'WFS URL',
    ...
    'postgis_attributes' => 'Select Columns (separate with comma; no spaces allowed)',
    'layer_search' => 'Searchable Properties (separate with comma; no spaces allowed)',
